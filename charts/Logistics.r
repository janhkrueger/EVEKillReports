...
cols <- c( "Scimitar"="red","Basilisk"="steelblue2","Guardian"="orange","Oneiros"="aquamarine4")
# print (cols)

graphtitle = paste("Logistics ",runyear,sep="")
...
p <- ggplot() + 
  ...
  xlab("Week") +
  ylab("Losses") +
  scale_colour_manual(name="Logistics",values=cols, guide = guide_legend(fill = NULL,colour = NULL) ) +
