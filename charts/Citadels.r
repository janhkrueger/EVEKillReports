...
cols <- c("Astrahus"="red","Fortizar"="blue","Keepstar"="orange")
graphtitle = paste("Citadels ",runyear,sep="")
...
p <- ggplot() + 
  ...
  xlab("Week") +
  ylab("Losses") +
  scale_colour_manual(name="Citadels",values=cols, guide = guide_legend(fill = NULL,colour = NULL) ) +
